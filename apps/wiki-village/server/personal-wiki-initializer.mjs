...
function renderedFiles(memberId, plan, context, existingClaude = null) {
  const base = `members/${memberId}`; const files = {}
  files[`${base}/CLAUDE.md`] = claudeWithRules(existingClaude === null ? context : existingClaude, plan)
